    ...
    if (alignment === "User") {
      try {
        ...
        if (response.status === 200) {
          console.log("LoggedInuser", response.data.loggedinuser); // Success response
      ...
      try {
        const response = await axios.post(
          `${server_url}api/service_provider/login`,
          formdata,
          {
            headers: { "Content-Type": "application/json" },
            withCredentials: true,
    ...
    <div className="flex flex-col justify-center items-center py-9">
      ...
      >
        <ToggleButton
          value="User"
          sx={{
            backgroundColor: alignment === "User" ? "steelblue" : "white",
            color: alignment === "User" ? "white" : "black",
          }}
        >
          User
        </ToggleButton>
        <ToggleButton
          ...
          sx={{
            backgroundColor:
              alignment === "Service Provider" ? "steelblue" : "white",
            color: alignment === "Service Provider" ? "white" : "black",
          }}
        >
          Service Provider
        </ToggleButton>
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <h1>
          Do not have account?
          <Link to="/signup" className="text-blue-950 font-bold">
            SignUp
          </Link>
        </h1>
      </div>
