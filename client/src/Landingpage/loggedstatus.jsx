...
const UserStatus=()=>{
    ...
    return(
        ...
        <div >
        {isOpen && (
        <div className="dropdown-menu flex flex-col justify-center items-center gap-y-6 absolute bg-slate-800 w-32 h-24 top-20 right-2 rounded-md text-white" ref={menuRef}>
          <ul className="flex flex-col justify-center items-center gap-y-2" >
            <li className="hover:bg-slate-700 w-32 flex justify-center cursor-pointer" onClick={userlogout}>LogOut</li>
            <li className="hover:bg-slate-700 w-32 flex justify-center cursor-pointer"
            onClick={myorders}>My Orders</li> 
          </ul>
        </div>
      )}
      </div>
...
const SellerStatus=()=>{
    ...
    return(
        ...
        <div >
        {isOpen && (
        <div className="dropdown-menu flex flex-col justify-center items-center gap-y-2 gap-x-2 absolute bg-slate-900  top-20 right-2 rounded-md text-white w-32 h-44" ref={menuRef}>
          <ul className="flex flex-col justify-center items-center gap-y-2" >
            <li className="hover:bg-slate-700 w-32 flex justify-center cursor-pointer" onClick={sellerlogout}>LogOut</li>
            <li className="hover:bg-slate-700 w-32 flex justify-center cursor-pointer" onClick={myservices}>My Services</li>
            <li className="hover:bg-slate-700 w-32 flex justify-center cursor-pointer" onClick={addservices}>Add Service</li> 
            <li className="hover:bg-slate-700 w-32 flex justify-center cursor-pointer"
            onClick={myorders}>My Orders</li>
            <li className="hover:bg-slate-700 w-32 flex justify-center cursor-pointer"
            onClick={clients}>Clients</li>
          </ul>
        </div>
      )}
      </div>
