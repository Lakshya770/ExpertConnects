  ...
  return (
    <div className="w-full h-5/6 relative mb-9">
      ...
      <div className="flex flex-wrap items-center justify-between space-x-32 space-y-24 w-5/6 ml-14 ">
        <div
          className="flex flex-col items-center justify-center text-center border-black border-2 p-4 w-32 h-40 ml-32 mt-24 rounded-md shadow-sm cursor-pointer hover:bg-gray-100 hover:scale-105 hover:shadow-lg transition-all duration-200"
        ...
        <div
          className="flex flex-col items-center justify-center text-center border-black border-2 p-4 w-32 h-40 rounded-md shadow-sm cursor-pointer hover:bg-gray-100 hover:scale-105 hover:shadow-lg transition-all duration-200 "
          onClick={() => handleclick("Accountant")}
        >
          <img
            alt="Accountant"
        ...
        <div
          className="flex flex-col items-center justify-center text-center border-black border-2 p-4 w-32 h-40 rounded-md shadow-sm cursor-pointer hover:bg-gray-100 hover:scale-105 hover:shadow-lg transition-all duration-200"
          onClick={() => handleclick("Veterinarian")}
        >
          <img
            alt="Veterinarian"
        ...
        <div
          className="flex flex-col items-center justify-center border-black border-2 p-4 w-32 h-40 text-center rounded-md shadow-sm cursor-pointer hover:bg-gray-100 hover:scale-105 hover:shadow-lg transition-all duration-200 "
        ...
        <div
          className="flex  flex-col items-center justify-center border-black border-2 p-4 w-32 h-40 text-center rounded-md shadow-sm cursor-pointer hover:bg-gray-100 hover:scale-105 hover:shadow-lg transition-all duration-200"
          onClick={() => handleclick("Psychologist")}
        >
          <img
            alt="Psychologist"
